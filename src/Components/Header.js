...
import Drawer from "./Drawer"; // Importing the Drawer component
        ...
        >
          ...
          {showDropdown && (
            <div className="dropdown">
              <Link to="/data-wired-wireless" className="dropdown-item">
                Data Wired & Wireless
              </Link>
              <Link to="/structured-cabling" className="dropdown-item">
                Structured Cabling
              </Link>
              <Link to="/data-center-solution" className="dropdown-item">
                Data Center Solution
              </Link>
              <Link to="/ict-elv-solutions" className="dropdown-item">
                ICT & ELV Solutions
              </Link>
              <Link to="/unified-voice-solution" className="dropdown-item">
